            ...
            <form onSubmit={handleLogin} onKeyDown={handleFormKeyDown}>
              ...
              <div className="text-center lg:text-left">
                <button
                  ...
                  className={`inline-block rounded bg-green-300 text-white px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out ${
                    isFormValid
